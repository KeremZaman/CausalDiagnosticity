...
EDIT_METHOD=$4
EXPL=$5
METRICS=("simulatability" "lanham-truncated-continuous" "lanham-mistakes-continuous" "lanham-paraphrase-continuous" "lanham-filler-continuous" "cc_shap-posthoc" "cc_shap-cot")
MODEL_NAME=$(echo "$MODEL" | tr '/' '_')

mkdir -p logs/$MODEL_NAME/$TASK
